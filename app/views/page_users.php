<?php $this->layout('template2', ['title' => 'users']);
?>
<?php try {
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            ...
            <div class="row" id="js-contacts">
                <?php foreach($users as $user): ?>
                    <div class="col-xl-4">
                        <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo strtolower($user['username']) ?>">
                            <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                                ...
                                <span class="status status-success mr-3">
                                    ...
                                    <div class="info-card-text flex-1">
                                        ...
                                        <?php if($this->checkRole() || $user['id'] == $id): ?>
                                            ...
                                            <?php endif ?>
                                        <span class="text-truncate text-truncate-xl"><?php echo $user['occupation'] ?></span>
                                    </div>
